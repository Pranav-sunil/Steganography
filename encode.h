...
/*  This file contains the function declerations for carrying out the 
    encoding process and structre decleration to store details        */

#define MAX_SECRET_BUF_SIZE 1
#define MAX_IMAGE_BUF_SIZE (MAX_SECRET_BUF_SIZE * 8)
#define MAX_FILE_SUFFIX 4

/* Structre decleration for storing various data
   required for encoding data to the image */
...
typedef struct _EncodeInfo
{
	...
	/* Magic String Signature Info*/
	char magic_string_sig[50];
